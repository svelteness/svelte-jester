...
<p>
This version requires Jest >= 27 and defaults to ESM. If you want to use CJS, you need to specify the **full path** for the jest transformer in your jest config.
</p>
